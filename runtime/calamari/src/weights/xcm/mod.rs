...
pub struct CalamariXcmWeight<RuntimeCall>(core::marker::PhantomData<RuntimeCall>);
impl<RuntimeCall> XcmWeightInfo<RuntimeCall> for CalamariXcmWeight<RuntimeCall> {
