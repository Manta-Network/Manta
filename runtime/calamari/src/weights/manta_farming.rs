...
//! DATE: 2023-06-05, STEPS: `1`, REPEAT: 1, LOW RANGE: `[]`, HIGH RANGE: `[]`
...
// pallet
// --chain=calamari-dev
// --pallet=manta_farming
// --extrinsic=*
// --heap-pages=4096
// --repeat=1
// --steps=1
// --template=.github/resources/frame-weight-template.hbs
// --output=manta-farming.rs
...
impl<T: frame_system::Config> manta_farming::WeightInfo for SubstrateWeight<T> {
    ...
    fn create_farming_pool() -> Weight {
        // Minimum execution time: 658_000 nanoseconds.
        Weight::from_ref_time(658_000_000)
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn deposit() -> Weight {
        // Minimum execution time: 3_884_000 nanoseconds.
        Weight::from_ref_time(3_884_000_000)
    ...
    fn withdraw() -> Weight {
        ...
        Weight::from_ref_time(439_000_000)
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    fn claim() -> Weight {
        // Minimum execution time: 473_000 nanoseconds.
    ...
    fn gauge_withdraw() -> Weight {
        ...
        Weight::from_ref_time(640_000_000)
