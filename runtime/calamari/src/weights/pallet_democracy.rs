...
impl<T: frame_system::Config> pallet_democracy::WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize_base(r: u32, ) -> Weight {
		(385_000 as Weight)
			...
			.saturating_add((3_653_000 as Weight).saturating_mul(r as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
	...
	fn on_initialize_base_with_launch_period(r: u32, ) -> Weight {
		(5_034_000 as Weight)
			// Standard Error: 8_000
			.saturating_add((3_670_000 as Weight).saturating_mul(r as Weight))
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(r as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	...
	fn delegate(r: u32, ) -> Weight {
		(30_684_000 as Weight)
			...
			.saturating_add((4_694_000 as Weight).saturating_mul(r as Weight))
