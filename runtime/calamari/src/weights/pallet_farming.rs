...
impl<T: frame_system::Config> pallet_farming::WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize() -> Weight {
		...
		Weight::from_ref_time(12_402_000)
	...
	fn create_farming_pool() -> Weight {
		...
		Weight::from_ref_time(24_763_000)
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn charge() -> Weight {
		// Minimum execution time: 63_297 nanoseconds.
		Weight::from_ref_time(68_225_000)
	...
	// Storage: Farming SharesAndWithdrawnRewards (r:1 w:1)
	fn withdraw() -> Weight {
		// Minimum execution time: 37_437 nanoseconds.
		Weight::from_ref_time(40_143_000)
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn gauge_withdraw() -> Weight {
		// Minimum execution time: 42_221 nanoseconds.
