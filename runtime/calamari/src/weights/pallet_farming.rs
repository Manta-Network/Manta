...
impl<T: frame_system::Config> pallet_farming::WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize() -> Weight {
		// Minimum execution time: 12_408 nanoseconds.
		Weight::from_ref_time(12_580_000)
	...
	fn create_farming_pool() -> Weight {
		...
		Weight::from_ref_time(25_458_000)
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn charge() -> Weight {
		// Minimum execution time: 63_160 nanoseconds.
		Weight::from_ref_time(64_696_000)
	...
	fn deposit() -> Weight {
		// Minimum execution time: 70_897 nanoseconds.
		Weight::from_ref_time(75_501_000)
	...
	// Storage: Farming SharesAndWithdrawnRewards (r:1 w:1)
	fn withdraw() -> Weight {
		// Minimum execution time: 37_523 nanoseconds.
	...
	fn claim() -> Weight {
		// Minimum execution time: 38_755 nanoseconds.
		Weight::from_ref_time(41_723_000)
	...
	fn gauge_withdraw() -> Weight {
		...
		Weight::from_ref_time(45_220_000)
