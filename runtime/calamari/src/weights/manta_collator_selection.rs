...
impl<T: frame_system::Config> manta_collator_selection::WeightInfo for SubstrateWeight<T> {
	...
	fn remove_collator(c: u32, ) -> Weight {
		(35_415_000 as Weight)
			...
			.saturating_add((403_000 as Weight).saturating_mul(c as Weight))
	...
	// Storage: CollatorSelection CandidacyBond (r:1 w:0)
	fn register_candidate(c: u32, ) -> Weight {
		(47_079_000 as Weight)
			// Standard Error: 5_000
			.saturating_add((436_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	...
	fn new_session(c: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((33_884_000 as Weight).saturating_mul(c as Weight))
