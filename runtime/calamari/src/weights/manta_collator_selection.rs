...
impl<T: frame_system::Config> manta_collator_selection::WeightInfo for SubstrateWeight<T> {
    ...
    fn leave_intent(c: u32, ) -> Weight {
        (30_528_000 as Weight)
            ...
            .saturating_add((455_000 as Weight).saturating_mul(c as Weight))
    ...
    fn register_candidate(c: u32, ) -> Weight {
        (39_357_000 as Weight)
            // Standard Error: 8_000
            .saturating_add((324_000 as Weight).saturating_mul(c as Weight))
            .saturating_add(T::DbWeight::get().reads(5 as Weight))
            .saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    ...
    fn new_session(c: u32, ) -> Weight {
        (22_452_000 as Weight)
            // Standard Error: 90_000
            .saturating_add((24_558_000 as Weight).saturating_mul(c as Weight))
