...
impl<T: frame_system::Config> manta_collator_selection::WeightInfo for SubstrateWeight<T> {
	...
	fn register_as_candidate(c: u32, ) -> Weight {
		(38_735_000 as Weight)
			// Standard Error: 4_000
			.saturating_add((381_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(5 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	// Storage: CollatorSelection Candidates (r:1 w:1)
	fn leave_intent(c: u32, ) -> Weight {
		(26_690_000 as Weight)
			// Standard Error: 4_000
	...
	fn new_session(c: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((27_297_000 as Weight).saturating_mul(c as Weight))
