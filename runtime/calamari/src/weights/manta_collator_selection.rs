...
impl<T: frame_system::Config> manta_collator_selection::WeightInfo for SubstrateWeight<T> {
	...
	fn set_invulnerables(b: u32, ) -> Weight {
		(9_489_000 as Weight)
			...
			.saturating_add((109_000 as Weight).saturating_mul(b as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	// Storage: CollatorSelection DesiredCandidates (r:0 w:1)
	fn set_desired_candidates() -> Weight {
		(10_700_000 as Weight)
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	...
	fn new_session(c: u32, ) -> Weight {
		(1_918_000 as Weight)
			...
			.saturating_add((25_519_000 as Weight).saturating_mul(c as Weight))
