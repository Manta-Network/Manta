...
impl<T: frame_system::Config> manta_collator_selection::WeightInfo for SubstrateWeight<T> {
    ...
    fn register_as_candidate(c: u32, ) -> Weight {
        (42_726_000 as Weight)
            ...
            .saturating_add((392_000 as Weight).saturating_mul(c as Weight))
    ...
    fn new_session(c: u32, ) -> Weight {
        (16_486_000 as Weight)
            ...
            .saturating_add((23_125_000 as Weight).saturating_mul(c as Weight))
