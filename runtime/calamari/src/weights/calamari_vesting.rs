...
impl<T: frame_system::Config> calamari_vesting::WeightInfo for SubstrateWeight<T> {
	...
	fn update_vesting_schedule() -> Weight {
		// Minimum execution time: 20_565 nanoseconds.
		Weight::from_ref_time(21_044_000)
	...
	fn vest() -> Weight {
		...
		Weight::from_ref_time(46_525_000)
	...
	// Storage: Balances Locks (r:1 w:1)
	fn vested_transfer() -> Weight {
		// Minimum execution time: 64_481 nanoseconds.
		Weight::from_ref_time(65_680_000)
			.saturating_add(T::DbWeight::get().reads(5))
			.saturating_add(T::DbWeight::get().writes(3))
	}
}
