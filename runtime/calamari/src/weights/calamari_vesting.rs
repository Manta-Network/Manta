...
// --heap-pages=4096
// --output=/home/jamie/my-repo/Manta/runtime/calamari/src/weights/calamari_vesting.rs
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	/// Proof: `CalamariVesting::VestingSchedule` (`max_values`: Some(1), `max_size`: None, mode: `Measured`)
	...
	fn update_vesting_schedule() -> Weight {
		...
		Weight::from_parts(16_541_000, 1603)
	...
	/// Proof: `CalamariVesting::VestingBalances` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn vest() -> Weight {
		...
		Weight::from_parts(52_228_000, 4764)
	...
	fn vested_transfer() -> Weight {
		...
		Weight::from_parts(102_483_000, 4764)
			.saturating_add(T::DbWeight::get().reads(6_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
}
