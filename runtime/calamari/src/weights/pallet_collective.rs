...
impl<T: frame_system::Config> pallet_collective::WeightInfo for SubstrateWeight<T> {
	...
	fn set_members(m: u32, n: u32, p: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((27_010_000 as Weight).saturating_mul(m as Weight))
			// Standard Error: 12_000
			.saturating_add((192_000 as Weight).saturating_mul(n as Weight))
			// Standard Error: 12_000
			.saturating_add((37_147_000 as Weight).saturating_mul(p as Weight))
