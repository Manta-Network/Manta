...
impl<T: frame_system::Config> pallet_membership::WeightInfo for SubstrateWeight<T> {
	...
	fn add_member(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(24_056_974)
			// Standard Error: 1_583
			.saturating_add(Weight::from_ref_time(55_882).saturating_mul(m.into()))
	...
	fn remove_member(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(27_129_395)
			// Standard Error: 906
			.saturating_add(Weight::from_ref_time(43_409).saturating_mul(m.into()))
	...
	/// The range of component `m` is `[2, 100]`.
	fn swap_member(m: u32, ) -> Weight {
		// Minimum execution time: 25_446 nanoseconds.
		Weight::from_ref_time(27_474_563)
			// Standard Error: 952
			.saturating_add(Weight::from_ref_time(53_924).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: CouncilMembership Members (r:1 w:1)
	...
	fn reset_member(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(27_180_369)
			// Standard Error: 1_305
			.saturating_add(Weight::from_ref_time(189_123).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	// Storage: CouncilMembership Members (r:1 w:1)
	...
	fn change_key(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(28_283_509)
			// Standard Error: 1_035
			.saturating_add(Weight::from_ref_time(52_756).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().reads(3))
	...
	fn set_prime(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(11_028_412)
			// Standard Error: 1_471
			.saturating_add(Weight::from_ref_time(16_370).saturating_mul(m.into()))
	...
	fn clear_prime(m: u32, ) -> Weight {
		...
		Weight::from_ref_time(5_594_327)
			// Standard Error: 144
			.saturating_add(Weight::from_ref_time(606).saturating_mul(m.into()))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}
