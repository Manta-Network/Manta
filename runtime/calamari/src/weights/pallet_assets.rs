...
impl<T: frame_system::Config> pallet_assets::WeightInfo for SubstrateWeight<T> {
	...
	fn destroy(c: u32, s: u32, a: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((16_884_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 50_000
			.saturating_add((19_626_000 as Weight).saturating_mul(s as Weight))
