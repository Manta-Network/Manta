...
// --output=runtime/calamari/src/weights/pallet_assets.rs
...
impl<T: frame_system::Config> pallet_assets::WeightInfo for SubstrateWeight<T> {
	...
	fn destroy(c: u32, s: u32, a: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((15_087_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 40_000
			.saturating_add((17_714_000 as Weight).saturating_mul(s as Weight))
			// Standard Error: 405_000
			.saturating_add((9_319_000 as Weight).saturating_mul(a as Weight))
