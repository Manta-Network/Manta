...
impl<T: frame_system::Config> pallet_manta_pay::WeightInfo for SubstrateWeight<T> {
	...
	fn to_private() -> Weight {
		// Minimum execution time: 39_484_243 nanoseconds.
		Weight::from_ref_time(39_523_228_000)
	...
	// Storage: MantaPay Shards (r:0 w:1)
	fn to_public() -> Weight {
		// Minimum execution time: 52_594_644 nanoseconds.
		Weight::from_ref_time(52_772_672_000)
	...
	fn private_transfer() -> Weight {
		// Minimum execution time: 70_666_922 nanoseconds.
		Weight::from_ref_time(70_882_633_000)
	...
	// Storage: Assets Account (r:2 w:2)
	fn public_transfer() -> Weight {
		// Minimum execution time: 49_949 nanoseconds.
		Weight::from_ref_time(69_694_000)
