...
impl<T: frame_system::Config> pallet_manta_pay::WeightInfo for SubstrateWeight<T> {
	...
	fn to_private() -> Weight {
		// Minimum execution time: 39_624_122 nanoseconds.
		Weight::from_ref_time(39_654_552_000)
	...
	// Storage: MantaPay Shards (r:0 w:1)
	fn to_public() -> Weight {
		// Minimum execution time: 52_557_152 nanoseconds.
		Weight::from_ref_time(52_583_559_000)
	...
	fn private_transfer() -> Weight {
		// Minimum execution time: 70_634_993 nanoseconds.
		Weight::from_ref_time(70_686_354_000)
	...
	fn public_transfer() -> Weight {
		...
		Weight::from_ref_time(54_832_000)
