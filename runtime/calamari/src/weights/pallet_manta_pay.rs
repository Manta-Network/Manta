...
impl<T: frame_system::Config> pallet_manta_pay::WeightInfo for SubstrateWeight<T> {
	...
	fn to_private() -> Weight {
		// Minimum execution time: 39_358_686 nanoseconds.
		Weight::from_ref_time(39_445_523_000)
	...
	// Storage: MantaPay Shards (r:0 w:1)
	fn to_public() -> Weight {
		// Minimum execution time: 52_503_782 nanoseconds.
		Weight::from_ref_time(52_623_987_000)
	...
	fn private_transfer() -> Weight {
		// Minimum execution time: 69_717_034 nanoseconds.
		Weight::from_ref_time(69_825_809_000)
	...
	// Storage: Assets Account (r:2 w:2)
	fn public_transfer() -> Weight {
		// Minimum execution time: 64_398 nanoseconds.
		Weight::from_ref_time(98_068_000)
