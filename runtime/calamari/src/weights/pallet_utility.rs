...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    fn batch(c: u32, ) -> Weight {
        (27_761_000 as Weight)
            ...
            .saturating_add((4_114_000 as Weight).saturating_mul(c as Weight))
    }
    fn as_derivative() -> Weight {
        (5_491_000 as Weight)
    }
    fn batch_all(c: u32, ) -> Weight {
        (24_786_000 as Weight)
            // Standard Error: 5_000
            .saturating_add((4_329_000 as Weight).saturating_mul(c as Weight))
    }
    fn dispatch_as() -> Weight {
        (13_489_000 as Weight)
    }
    fn force_batch(c: u32, ) -> Weight {
        (35_979_000 as Weight)
            // Standard Error: 5_000
            .saturating_add((4_099_000 as Weight).saturating_mul(c as Weight))
    }
}
