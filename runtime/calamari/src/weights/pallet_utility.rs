...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	fn batch(c: u32, ) -> Weight {
		(50_302_000 as Weight)
			// Standard Error: 8_000
			.saturating_add((12_826_000 as Weight).saturating_mul(c as Weight))
	}
	fn as_derivative() -> Weight {
		(7_060_000 as Weight)
	}
	fn batch_all(c: u32, ) -> Weight {
		(41_751_000 as Weight)
			...
			.saturating_add((13_849_000 as Weight).saturating_mul(c as Weight))
	}
	fn dispatch_as() -> Weight {
		(28_301_000 as Weight)
	}
}
