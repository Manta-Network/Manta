...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    fn batch(c: u32, ) -> Weight {
        (26_254_000 as Weight)
            ...
            .saturating_add((4_850_000 as Weight).saturating_mul(c as Weight))
    }
    fn as_derivative() -> Weight {
        (6_160_000 as Weight)
    }
    fn batch_all(c: u32, ) -> Weight {
        (38_604_000 as Weight)
            // Standard Error: 5_000
            .saturating_add((5_043_000 as Weight).saturating_mul(c as Weight))
    }
    fn dispatch_as() -> Weight {
        (13_868_000 as Weight)
    }
    fn force_batch(c: u32, ) -> Weight {
        (27_186_000 as Weight)
            // Standard Error: 5_000
            .saturating_add((4_859_000 as Weight).saturating_mul(c as Weight))
    }
}
