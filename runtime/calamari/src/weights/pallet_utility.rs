...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(1_008_160, 0)
			// Standard Error: 2_386
			.saturating_add(Weight::from_parts(4_110_650, 0).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(4_594_133, 0)
			// Standard Error: 2_414
			.saturating_add(Weight::from_parts(4_396_079, 0).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(9_921_739, 0)
			// Standard Error: 2_395
			.saturating_add(Weight::from_parts(3_996_386, 0).saturating_mul(c.into()))
	}
}
