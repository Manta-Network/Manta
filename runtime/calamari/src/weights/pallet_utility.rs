...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(10_945_026, 0)
			// Standard Error: 2_358
			.saturating_add(Weight::from_parts(5_965_587, 0).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(11_090_493, 0)
			// Standard Error: 2_808
			.saturating_add(Weight::from_parts(6_286_673, 0).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(19_435_164, 0)
			// Standard Error: 2_620
			.saturating_add(Weight::from_parts(5_860_664, 0).saturating_mul(c.into()))
	}
}
