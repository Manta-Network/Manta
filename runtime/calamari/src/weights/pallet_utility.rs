...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(50_801_365)
			// Standard Error: 4_645
			.saturating_add(Weight::from_ref_time(5_056_354).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(41_223_607)
			// Standard Error: 2_963
			.saturating_add(Weight::from_ref_time(5_297_557).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Minimum execution time: 15_686 nanoseconds.
		Weight::from_ref_time(15_977_000)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		// Minimum execution time: 12_630 nanoseconds.
		Weight::from_ref_time(34_383_934)
			// Standard Error: 3_035
			.saturating_add(Weight::from_ref_time(5_085_386).saturating_mul(c.into()))
	}
}
