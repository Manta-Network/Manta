...
mod multiplier_tests {
    ...
    fn congested_chain_simulation() {
        ...
        let max_number_of_remarks_per_block = 10u128;
        ...
        run_with_system_weight(block_weight, || {
            ...
            let mut fee_adjustment = MinimumMultiplier::get();
            // let mut fee_adjustment = Multiplier::one() / 1_000_000.into();
            let mut fee_adjustment2 = Multiplier::one() * 1_000_000_000.into();
            let mut fee_adjustment3 = Multiplier::one().saturating_mul_int(1_000_000_000);
            // let mut fee_adjustment4 = 1_000_000_000.into() * fee_adjustment;
            let mut fee_adjustment5 = fee_adjustment.saturating_mul_int(1_000_000_000);
            ...
            for iteration in 0..7200 {
                ...
                let adjusted_fee_partial = fee_adjustment.saturating_mul_int(fee);
                let adjusted_fee = adjusted_fee_partial + base_fee + len_fee;
            ...
            for iteration in 0..7200 {
                ...
                // https://docs.substrate.io/main-docs/build/tx-weights-fees/#:~:text=A%20closer%20look%20at%20the%20inclusion%20fee
                let adjusted_fee_partial = fee_adjustment.saturating_mul_int(fee);
                let adjusted_fee = adjusted_fee_partial + base_fee / 10 + len_fee / 10;
                accumulated_fee += adjusted_fee;
                println!(
                    "Iteration {}, New fee_adjustment = {:?}. Adjusted Fee: {} KMA, Total Fee: {} KMA, Dollar Value: {}",
                    iteration,
