...
mod multiplier_tests {
	use crate::{Runtime, RuntimeBlockWeights as BlockWeights, System, TransactionPayment, DOL};
	...
	fn congested_chain_simulation() {
		...
		let target_daily_congestion_cost_kma =
			(target_daily_congestion_cost_usd as f32 * kma_price * DOL as f32) as u128;
		...
		run_with_system_weight(block_weight, || {
			...
			for iteration in 0..7200 {
				...
				println!(
					"Iteration {}, New fee_adjustment = {:?}. Adjusted Fee: {} DOL, Total Fee: {} DOL, Dollar Vlaue: {}",
					iteration,
					fee_adjustment,
					adjusted_fee / DOL,
					accumulated_fee / DOL,
					(accumulated_fee / DOL) as f32 * kma_price,
				);
			}
