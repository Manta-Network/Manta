...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize_periodic_named_resolved(s: u32, ) -> Weight {
		(16_004_000 as Weight)
			// Standard Error: 46_000
			.saturating_add((26_449_000 as Weight).saturating_mul(s as Weight))
	...
	fn on_initialize_named_resolved(s: u32, ) -> Weight {
		(11_702_000 as Weight)
			// Standard Error: 46_000
			.saturating_add((21_621_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
	...
	// Storage: Preimage StatusFor (r:1 w:1)
	fn on_initialize_periodic_resolved(s: u32, ) -> Weight {
		(14_892_000 as Weight)
			// Standard Error: 51_000
			.saturating_add((23_579_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((3 as Weight).saturating_mul(s as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((3 as Weight).saturating_mul(s as Weight)))
	...
	fn on_initialize_resolved(s: u32, ) -> Weight {
		(9_920_000 as Weight)
			// Standard Error: 46_000
			.saturating_add((20_402_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(s as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	...
	fn on_initialize_named_aborted(s: u32, ) -> Weight {
		(6_689_000 as Weight)
			...
			.saturating_add((10_111_000 as Weight).saturating_mul(s as Weight))
	...
	fn on_initialize_aborted(s: u32, ) -> Weight {
		(8_298_000 as Weight)
			...
			.saturating_add((7_291_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(s as Weight)))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
	}
	...
	fn on_initialize_periodic_named(s: u32, ) -> Weight {
		(15_542_000 as Weight)
			...
			.saturating_add((15_783_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(s as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((2 as Weight).saturating_mul(s as Weight)))
	...
	// Storage: Scheduler Agenda (r:2 w:2)
	fn on_initialize_periodic(s: u32, ) -> Weight {
		(13_357_000 as Weight)
			// Standard Error: 39_000
			.saturating_add((12_935_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(s as Weight)))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(s as Weight)))
	...
	fn on_initialize_named(s: u32, ) -> Weight {
		(12_607_000 as Weight)
			...
			.saturating_add((10_930_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
			.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(s as Weight)))
	}
	...
	fn on_initialize(s: u32, ) -> Weight {
		(12_203_000 as Weight)
			...
			.saturating_add((9_789_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
			.saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	// Storage: Scheduler Agenda (r:1 w:1)
