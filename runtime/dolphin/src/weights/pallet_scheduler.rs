...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for SubstrateWeight<T> {
    ...
    fn on_initialize_periodic_named_resolved(s: u32, ) -> Weight {
        (16_662_000 as Weight)
            ...
            .saturating_add((28_139_000 as Weight).saturating_mul(s as Weight))
    ...
    fn on_initialize_named_resolved(s: u32, ) -> Weight {
        (16_162_000 as Weight)
            ...
            .saturating_add((22_832_000 as Weight).saturating_mul(s as Weight))
            .saturating_add(T::DbWeight::get().reads(1 as Weight))
    ...
    fn on_initialize_periodic_resolved(s: u32, ) -> Weight {
        (14_103_000 as Weight)
            ...
            .saturating_add((25_134_000 as Weight).saturating_mul(s as Weight))
            .saturating_add(T::DbWeight::get().reads(1 as Weight))
            .saturating_add(T::DbWeight::get().reads((3 as Weight).saturating_mul(s as Weight)))
            .saturating_add(T::DbWeight::get().writes(1 as Weight))
            .saturating_add(T::DbWeight::get().writes((3 as Weight).saturating_mul(s as Weight)))
    ...
    fn on_initialize_resolved(s: u32, ) -> Weight {
        (16_007_000 as Weight)
            // Standard Error: 47_000
            .saturating_add((21_575_000 as Weight).saturating_mul(s as Weight))
            .saturating_add(T::DbWeight::get().reads(1 as Weight))
            .saturating_add(T::DbWeight::get().reads((2 as Weight).saturating_mul(s as Weight)))
            .saturating_add(T::DbWeight::get().writes(1 as Weight))
    ...
    fn on_initialize_named_aborted(s: u32, ) -> Weight {
        (6_698_000 as Weight)
            ...
            .saturating_add((9_774_000 as Weight).saturating_mul(s as Weight))
    ...
    fn on_initialize_periodic(s: u32, ) -> Weight {
        (15_821_000 as Weight)
            ...
            .saturating_add((13_868_000 as Weight).saturating_mul(s as Weight))
            .saturating_add(T::DbWeight::get().reads(1 as Weight))
            .saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(s as Weight)))
            .saturating_add(T::DbWeight::get().writes(1 as Weight))
            .saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(s as Weight)))
    ...
    fn on_initialize_named(s: u32, ) -> Weight {
        (14_230_000 as Weight)
            ...
            .saturating_add((11_751_000 as Weight).saturating_mul(s as Weight))
            .saturating_add(T::DbWeight::get().reads(1 as Weight))
            .saturating_add(T::DbWeight::get().writes(1 as Weight))
            .saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(s as Weight)))
    }
    ...
    fn on_initialize(s: u32, ) -> Weight {
        (15_964_000 as Weight)
            ...
            .saturating_add((10_426_000 as Weight).saturating_mul(s as Weight))
            .saturating_add(T::DbWeight::get().reads(1 as Weight))
            .saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    // Storage: Scheduler Agenda (r:1 w:1)
