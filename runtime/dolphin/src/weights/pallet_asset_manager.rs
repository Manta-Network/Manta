...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for SubstrateWeight<T> {
	...
	fn register_asset() -> Weight {
		// Minimum execution time: 120_708 nanoseconds.
		Weight::from_ref_time(122_404_000)
	...
	fn set_units_per_second() -> Weight {
		// Minimum execution time: 57_631 nanoseconds.
	...
	fn update_asset_location() -> Weight {
		// Minimum execution time: 77_448 nanoseconds.
		Weight::from_ref_time(79_071_000)
			.saturating_add(T::DbWeight::get().reads(4))
	...
	// Storage: AssetManager AssetIdMetadata (r:0 w:1)
	fn update_asset_metadata() -> Weight {
		// Minimum execution time: 74_765 nanoseconds.
		Weight::from_ref_time(76_384_000)
	...
	fn mint_asset() -> Weight {
		// Minimum execution time: 83_346 nanoseconds.
		Weight::from_ref_time(86_076_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: AssetManager MinXcmFee (r:0 w:1)
	fn set_min_xcm_fee() -> Weight {
		// Minimum execution time: 45_918 nanoseconds.
		Weight::from_ref_time(48_152_000)
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
