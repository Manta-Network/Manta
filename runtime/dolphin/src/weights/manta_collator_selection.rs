...
impl<T: frame_system::Config> manta_collator_selection::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_invulnerables(b: u32, ) -> Weight {
        (9_679_000 as Weight)
            ...
            .saturating_add((124_000 as Weight).saturating_mul(b as Weight))
    ...
    fn new_session(c: u32, ) -> Weight {
        (17_189_000 as Weight)
            ...
            .saturating_add((24_785_000 as Weight).saturating_mul(c as Weight))
