...
impl<T: frame_system::Config> manta_collator_selection::WeightInfo for SubstrateWeight<T> {
    ...
    fn register_as_candidate(c: u32, ) -> Weight {
        (44_713_000 as Weight)
            ...
            .saturating_add((444_000 as Weight).saturating_mul(c as Weight))
    ...
    fn leave_intent(c: u32, ) -> Weight {
        (31_894_000 as Weight)
            ...
            .saturating_add((405_000 as Weight).saturating_mul(c as Weight))
    ...
    fn new_session(c: u32, ) -> Weight {
        (5_972_000 as Weight)
            ...
            .saturating_add((24_527_000 as Weight).saturating_mul(c as Weight))
