...
impl<T: frame_system::Config> manta_collator_selection::WeightInfo for SubstrateWeight<T> {
	...
	fn set_invulnerables(b: u32, ) -> Weight {
		(7_238_000 as Weight)
			...
			.saturating_add((163_000 as Weight).saturating_mul(b as Weight))
	...
	fn new_session(c: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((23_190_000 as Weight).saturating_mul(c as Weight))
