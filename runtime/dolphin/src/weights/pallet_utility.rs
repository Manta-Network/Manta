...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(40_489_217)
			// Standard Error: 5_864
			.saturating_add(Weight::from_ref_time(4_592_627).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
		// Minimum execution time: 6_809 nanoseconds.
		Weight::from_ref_time(6_981_000)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn batch_all(c: u32, ) -> Weight {
		// Minimum execution time: 39_817 nanoseconds.
		Weight::from_ref_time(69_169_779)
			// Standard Error: 6_316
			.saturating_add(Weight::from_ref_time(4_724_800).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(54_184_897)
			// Standard Error: 5_829
			.saturating_add(Weight::from_ref_time(4_546_849).saturating_mul(c.into()))
	}
}
