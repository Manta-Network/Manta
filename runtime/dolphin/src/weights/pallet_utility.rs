...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    fn batch(c: u32, ) -> Weight {
        (21_335_000 as Weight)
            // Standard Error: 5_000
            .saturating_add((3_702_000 as Weight).saturating_mul(c as Weight))
    }
    fn as_derivative() -> Weight {
        (2_065_000 as Weight)
    }
    ...
    fn batch_all(c: u32, ) -> Weight {
        (29_242_000 as Weight)
            // Standard Error: 5_000
            .saturating_add((3_896_000 as Weight).saturating_mul(c as Weight))
    ...
    fn force_batch(c: u32, ) -> Weight {
        (24_099_000 as Weight)
            ...
            .saturating_add((3_690_000 as Weight).saturating_mul(c as Weight))
    }
}
