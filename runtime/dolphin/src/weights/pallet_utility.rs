...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    fn batch(c: u32, ) -> Weight {
        (29_296_000 as Weight)
            // Standard Error: 4_000
            .saturating_add((4_517_000 as Weight).saturating_mul(c as Weight))
    }
    fn as_derivative() -> Weight {
        (5_802_000 as Weight)
    }
    fn batch_all(c: u32, ) -> Weight {
        (32_430_000 as Weight)
            // Standard Error: 4_000
            .saturating_add((4_788_000 as Weight).saturating_mul(c as Weight))
    }
    fn dispatch_as() -> Weight {
    ...
    fn force_batch(c: u32, ) -> Weight {
        (25_852_000 as Weight)
            // Standard Error: 4_000
            .saturating_add((4_533_000 as Weight).saturating_mul(c as Weight))
    }
}
