...
impl<T: frame_system::Config> pallet_manta_pay::WeightInfo for SubstrateWeight<T> {
	...
	fn to_private() -> Weight {
		// Minimum execution time: 39_532_346 nanoseconds.
		Weight::from_ref_time(39_546_794_000)
	...
	// Storage: MantaPay Shards (r:0 w:1)
	fn to_public() -> Weight {
		// Minimum execution time: 52_745_571 nanoseconds.
		Weight::from_ref_time(52_762_020_000)
	...
	fn private_transfer() -> Weight {
		// Minimum execution time: 70_101_552 nanoseconds.
		Weight::from_ref_time(70_112_351_000)
	...
	// Storage: Assets Account (r:2 w:2)
	fn public_transfer() -> Weight {
		// Minimum execution time: 49_653 nanoseconds.
		Weight::from_ref_time(50_260_000)
