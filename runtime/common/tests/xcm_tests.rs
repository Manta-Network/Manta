...
use codec::Encode;
use frame_support::{
	assert_err, assert_noop, assert_ok, traits::Currency, weights::constants::WEIGHT_PER_SECOND,
};
...
fn filtered_multilocation_should_not_work() {
	...
	// Sending xcm to parachain 3 should not work
	ParaA::execute_with(|| {
		// free execution, full amount received
		assert_noop!(
