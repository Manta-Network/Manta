...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(41_270_866)
			// Standard Error: 2_889
			.saturating_add(Weight::from_ref_time(5_067_788).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
	...
	/// The range of component `c` is `[0, 1000]`.
	fn batch_all(c: u32, ) -> Weight {
		// Minimum execution time: 12_378 nanoseconds.
		Weight::from_ref_time(35_524_315)
			// Standard Error: 3_108
			.saturating_add(Weight::from_ref_time(5_357_815).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Minimum execution time: 15_730 nanoseconds.
		Weight::from_ref_time(16_116_000)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		// Minimum execution time: 12_810 nanoseconds.
		Weight::from_ref_time(33_361_568)
			// Standard Error: 3_009
			.saturating_add(Weight::from_ref_time(5_061_791).saturating_mul(c.into()))
	}
}
