...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(3_466_574, 0)
			// Standard Error: 2_620
			.saturating_add(Weight::from_parts(6_104_742, 0).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(14_991_706, 0)
			// Standard Error: 2_273
			.saturating_add(Weight::from_parts(6_394_331, 0).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(15_613_646, 0)
			// Standard Error: 2_608
			.saturating_add(Weight::from_parts(6_010_164, 0).saturating_mul(c.into()))
	}
}
