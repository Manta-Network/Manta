...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(11_302_637, 0)
			// Standard Error: 2_378
			.saturating_add(Weight::from_parts(4_088_453, 0).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(13_627_602, 0)
			// Standard Error: 2_396
			.saturating_add(Weight::from_parts(4_365_682, 0).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(11_165_811, 0)
			// Standard Error: 2_353
			.saturating_add(Weight::from_parts(3_974_739, 0).saturating_mul(c.into()))
	}
}
