...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(5_768_044, 0)
			// Standard Error: 2_207
			.saturating_add(Weight::from_parts(4_118_862, 0).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(206_641, 0)
			// Standard Error: 2_390
			.saturating_add(Weight::from_parts(4_429_637, 0).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(8_212_854, 0)
			// Standard Error: 2_636
			.saturating_add(Weight::from_parts(4_002_374, 0).saturating_mul(c.into()))
	}
}
