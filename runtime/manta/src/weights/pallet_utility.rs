...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(34_462_898)
			// Standard Error: 2_638
			.saturating_add(Weight::from_ref_time(5_169_337).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(33_206_677)
			// Standard Error: 2_528
			.saturating_add(Weight::from_ref_time(5_420_714).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
	...
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		// Minimum execution time: 13_197 nanoseconds.
		Weight::from_ref_time(35_694_978)
			// Standard Error: 2_861
			.saturating_add(Weight::from_ref_time(5_152_510).saturating_mul(c.into()))
	}
}
