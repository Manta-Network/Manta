...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(30_876_104)
			// Standard Error: 3_056
			.saturating_add(Weight::from_ref_time(5_054_949).saturating_mul(c.into()))
	}
	fn as_derivative() -> Weight {
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(35_377_282)
			// Standard Error: 2_775
			.saturating_add(Weight::from_ref_time(5_354_798).saturating_mul(c.into()))
	}
	fn dispatch_as() -> Weight {
		// Minimum execution time: 15_263 nanoseconds.
		Weight::from_ref_time(15_601_000)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		// Minimum execution time: 12_512 nanoseconds.
		Weight::from_ref_time(29_333_685)
			// Standard Error: 2_619
			.saturating_add(Weight::from_ref_time(5_066_016).saturating_mul(c.into()))
	}
}
