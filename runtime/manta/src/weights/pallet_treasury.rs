...
impl<T: frame_system::Config> pallet_treasury::WeightInfo for SubstrateWeight<T> {
	...
	fn propose_spend() -> Weight {
		...
		Weight::from_parts(30_226_000, 1489)
	...
	fn approve_proposal(p: u32, ) -> Weight {
		...
		Weight::from_parts(13_809_036, 3573)
			// Standard Error: 803
			.saturating_add(Weight::from_parts(78_024, 0).saturating_mul(p.into()))
			.saturating_add(T::DbWeight::get().reads(2_u64))
	...
	fn remove_approval() -> Weight {
		...
		Weight::from_parts(9_013_000, 1887)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		...
		Weight::from_parts(34_234_121, 1887)
			// Standard Error: 9_933
			.saturating_add(Weight::from_parts(41_919_106, 0).saturating_mul(p.into()))
