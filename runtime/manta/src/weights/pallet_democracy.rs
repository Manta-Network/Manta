...
impl<T: frame_system::Config> pallet_democracy::WeightInfo for SubstrateWeight<T> {
    ...
    fn on_initialize_base(r: u32, ) -> Weight {
        (3_572_000 as Weight)
            ...
            .saturating_add((3_522_000 as Weight).saturating_mul(r as Weight))
            .saturating_add(T::DbWeight::get().reads(2 as Weight))
    ...
    fn on_initialize_base_with_launch_period(r: u32, ) -> Weight {
        (8_665_000 as Weight)
            ...
            .saturating_add((3_544_000 as Weight).saturating_mul(r as Weight))
            .saturating_add(T::DbWeight::get().reads(5 as Weight))
            .saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(r as Weight)))
            .saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    ...
    fn delegate(r: u32, ) -> Weight {
        (42_281_000 as Weight)
            // Standard Error: 8_000
            .saturating_add((4_575_000 as Weight).saturating_mul(r as Weight))
    ...
    fn undelegate(r: u32, ) -> Weight {
        (20_504_000 as Weight)
            ...
            .saturating_add((4_651_000 as Weight).saturating_mul(r as Weight))
            .saturating_add(T::DbWeight::get().reads(2 as Weight))
            .saturating_add(T::DbWeight::get().reads((1 as Weight).saturating_mul(r as Weight)))
            .saturating_add(T::DbWeight::get().writes(2 as Weight))
            .saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(r as Weight)))
