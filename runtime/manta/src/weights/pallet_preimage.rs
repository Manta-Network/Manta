...
impl<T: frame_system::Config> pallet_preimage::WeightInfo for SubstrateWeight<T> {
	...
	/// The range of component `s` is `[0, 4194304]`.
	fn note_requested_preimage(s: u32, ) -> Weight {
		// Minimum execution time: 33_051 nanoseconds.
	...
	fn note_no_deposit_preimage(s: u32, ) -> Weight {
		...
		Weight::from_ref_time(22_192_000)
			// Standard Error: 1
	...
	// Storage: Preimage PreimageFor (r:0 w:1)
	fn unnote_no_deposit_preimage() -> Weight {
		// Minimum execution time: 29_768 nanoseconds.
		Weight::from_ref_time(30_547_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: Preimage StatusFor (r:1 w:1)
	fn request_preimage() -> Weight {
		// Minimum execution time: 29_067 nanoseconds.
		Weight::from_ref_time(29_710_000)
			.saturating_add(T::DbWeight::get().reads(1))
	...
	fn request_unnoted_preimage() -> Weight {
		...
		Weight::from_ref_time(22_327_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: Preimage StatusFor (r:1 w:1)
	fn request_requested_preimage() -> Weight {
		// Minimum execution time: 10_136 nanoseconds.
	...
	fn unrequest_preimage() -> Weight {
		...
		Weight::from_ref_time(29_149_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: Preimage StatusFor (r:1 w:1)
	fn unrequest_unnoted_preimage() -> Weight {
		...
		Weight::from_ref_time(10_333_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: Preimage StatusFor (r:1 w:1)
	fn unrequest_multi_referenced_preimage() -> Weight {
		...
		Weight::from_ref_time(10_168_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
