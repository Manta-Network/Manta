...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for SubstrateWeight<T> {
	...
	fn register_asset() -> Weight {
		// Minimum execution time: 50_656 nanoseconds.
		Weight::from_ref_time(51_549_000)
	...
	fn set_units_per_second() -> Weight {
		// Minimum execution time: 61_452 nanoseconds.
	...
	fn update_asset_location() -> Weight {
		// Minimum execution time: 77_867 nanoseconds.
		Weight::from_ref_time(80_379_000)
			.saturating_add(T::DbWeight::get().reads(4))
	...
	fn update_asset_metadata() -> Weight {
		...
		Weight::from_ref_time(78_390_000)
	...
	fn mint_asset() -> Weight {
		// Minimum execution time: 80_246 nanoseconds.
		Weight::from_ref_time(83_592_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: AssetManager MinXcmFee (r:0 w:1)
	fn set_min_xcm_fee() -> Weight {
		// Minimum execution time: 47_273 nanoseconds.
		Weight::from_ref_time(49_791_000)
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn register_lp_asset() -> Weight {
		// Minimum execution time: 57_299 nanoseconds.
		Weight::from_ref_time(58_374_000)
