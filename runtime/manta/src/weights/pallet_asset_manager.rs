...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for SubstrateWeight<T> {
	...
	fn register_asset() -> Weight {
		// Minimum execution time: 51_003 nanoseconds.
		Weight::from_ref_time(51_801_000)
	...
	fn set_units_per_second() -> Weight {
		// Minimum execution time: 61_944 nanoseconds.
		Weight::from_ref_time(64_424_000)
	...
	fn update_asset_location() -> Weight {
		...
		Weight::from_ref_time(79_857_000)
			.saturating_add(T::DbWeight::get().reads(4))
	...
	// Storage: AssetManager AssetIdMetadata (r:0 w:1)
	fn update_asset_metadata() -> Weight {
		// Minimum execution time: 74_870 nanoseconds.
		Weight::from_ref_time(77_347_000)
	...
	fn mint_asset() -> Weight {
		// Minimum execution time: 83_670 nanoseconds.
		Weight::from_ref_time(85_846_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: AssetManager MinXcmFee (r:0 w:1)
	fn set_min_xcm_fee() -> Weight {
		// Minimum execution time: 47_429 nanoseconds.
		Weight::from_ref_time(50_365_000)
			.saturating_add(T::DbWeight::get().writes(1))
	}
	fn update_outgoing_filtered_assets() -> Weight {
