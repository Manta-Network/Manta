...
impl<T: frame_system::Config> pallet_asset_manager::WeightInfo for SubstrateWeight<T> {
	...
	fn register_asset() -> Weight {
		...
		Weight::from_ref_time(52_028_000)
	...
	fn set_units_per_second() -> Weight {
		// Minimum execution time: 55_166 nanoseconds.
		Weight::from_ref_time(57_981_000)
	...
	fn update_asset_location() -> Weight {
		// Minimum execution time: 72_733 nanoseconds.
		Weight::from_ref_time(75_431_000)
			.saturating_add(T::DbWeight::get().reads(4))
	...
	fn update_asset_metadata() -> Weight {
		...
		Weight::from_ref_time(73_375_000)
	...
	fn mint_asset() -> Weight {
		// Minimum execution time: 78_943 nanoseconds.
		Weight::from_ref_time(81_164_000)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn register_lp_asset() -> Weight {
		// Minimum execution time: 56_552 nanoseconds.
		Weight::from_ref_time(57_591_000)
