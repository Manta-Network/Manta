...
impl<T: frame_system::Config> pallet_manta_pay::WeightInfo for SubstrateWeight<T> {
	...
	fn to_private() -> Weight {
		// Minimum execution time: 39_348_313 nanoseconds.
		Weight::from_ref_time(39_377_947_000)
	...
	// Storage: MantaPay Shards (r:0 w:1)
	fn to_public() -> Weight {
		// Minimum execution time: 52_955_270 nanoseconds.
		Weight::from_ref_time(52_985_380_000)
	...
	fn private_transfer() -> Weight {
		// Minimum execution time: 69_811_430 nanoseconds.
		Weight::from_ref_time(69_860_894_000)
	...
	// Storage: Assets Account (r:2 w:2)
	fn public_transfer() -> Weight {
		// Minimum execution time: 92_777 nanoseconds.
		Weight::from_ref_time(147_327_000)
