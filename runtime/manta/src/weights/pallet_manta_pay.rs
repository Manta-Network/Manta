...
impl<T: frame_system::Config> pallet_manta_pay::WeightInfo for SubstrateWeight<T> {
	...
	fn to_private() -> Weight {
		// Minimum execution time: 39_528_201 nanoseconds.
		Weight::from_ref_time(39_548_828_000)
	...
	// Storage: MantaPay Shards (r:0 w:1)
	fn to_public() -> Weight {
		// Minimum execution time: 52_528_536 nanoseconds.
		Weight::from_ref_time(52_542_716_000)
	...
	fn private_transfer() -> Weight {
		// Minimum execution time: 70_602_285 nanoseconds.
		Weight::from_ref_time(70_703_220_000)
	...
	// Storage: Assets Account (r:2 w:2)
	fn public_transfer() -> Weight {
		// Minimum execution time: 51_449 nanoseconds.
