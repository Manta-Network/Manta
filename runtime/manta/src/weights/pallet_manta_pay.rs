...
impl<T: frame_system::Config> pallet_manta_pay::WeightInfo for SubstrateWeight<T> {
	...
	fn to_private() -> Weight {
		// Minimum execution time: 39_421_816 nanoseconds.
		Weight::from_ref_time(39_442_588_000)
	...
	// Storage: MantaPay Shards (r:0 w:1)
	fn to_public() -> Weight {
		// Minimum execution time: 52_867_215 nanoseconds.
		Weight::from_ref_time(52_959_241_000)
	...
	fn private_transfer() -> Weight {
		// Minimum execution time: 72_727_522 nanoseconds.
		Weight::from_ref_time(72_757_960_000)
