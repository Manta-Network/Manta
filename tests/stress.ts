...
async function main(){
    ...
    const utxo_per_shard_amount = 128;
    ...
    const shards_call = api.tx.system.setStorage(all_items);
    ...
    for(var i = 0; i < all_entries; ++i) {
        ...
        all_vsios.push([vsio_storage_key, '0xefe34cfd4418c9b1c04e555965e479d00ec4814ed0cd94641df1a8c6f9fa1071']);
    }

    const call = api.tx.system.setStorage(all_vsios);
