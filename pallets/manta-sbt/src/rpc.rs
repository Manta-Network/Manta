...
use crate::{runtime::SBTPullLedgerDiffApi, Checkpoint, InitialSyncResponse, PullResponse};
use alloc::sync::Arc;
...
use manta_support::manta_pay::{DenseInitialSyncResponse, DensePullResponse};
...
pub trait SBTPullApi {
    ...
    #[method(name = "mantaSBT_initial_pull", blocking)]
    fn initial_pull(
        &self,
        checkpoint: Checkpoint,
        max_receivers: u64,
    ...
    #[method(name = "mantaSBT_dense_initial_pull", blocking)]
