...
benchmarks! {
    ...
    verify {
        ...
        assert_eq!(
            ...
            Some(CandidateBondLessRequest {
                ...
                when_executable: 1 + <<T as Config>::LeaveCandidatesDelay as Get<u32>>::get(),
            })
        );
    }
    ...
    execute_leave_delegators {
        ...
        roll_to_and_author::<T>(<<T as Config>::LeaveCandidatesDelay as Get<u32>>::get(), author);
    ...
    execute_revoke_delegation {
        ...
        roll_to_and_author::<T>(<<T as Config>::LeaveCandidatesDelay as Get<u32>>::get(), collator.clone());
    }: {
