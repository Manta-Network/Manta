...
use super::*;
use crate::command::{DOLPHIN_PARACHAIN_ID, DOLPHIN_PARACHAIN_ON_ROCOCO_ID};
...
pub fn dolphin_2084_testnet_on_rococo_config() -> Result<DolphinChainSpec, String> {
	let mut spec = DolphinChainSpec::from_json_bytes(
		&include_bytes!("../../../genesis/dolphin-2084-testnet-on-rococo.json")[..],
	)?;
	spec.extensions_mut().para_id = DOLPHIN_PARACHAIN_ON_ROCOCO_ID;
	Ok(spec)
}

// pub fn dolphin_2084_testnet_on_rococo_config() -> DolphinChainSpec {
// 	let properties = dolphin_properties();
...
// 	DolphinChainSpec::from_genesis(
// 		// Name
// 		"Dolphin 2084 Parachain Testnet",
// 		// ID
// 		"dolphin_2084_testnet",
// 		ChainType::Live,
...
// 			para_id: DOLPHIN_PARACHAIN_ON_ROCOCO_ID,
// 		},
// 	)
// }
...
// 		},
// 		parachain_info: dolphin_runtime::ParachainInfoConfig {
// 			parachain_id: DOLPHIN_PARACHAIN_ON_ROCOCO_ID.into(),
// 		},
// 		collator_selection: dolphin_runtime::CollatorSelectionConfig {
